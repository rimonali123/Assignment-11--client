...
const SingleServiceDetails = () => {
    ...
    return (
        <div className="mt-10">
            <Helmet>
                <title>Single Service Details | ConsultHub</title>
            </Helmet>

            <div className="hidden lg:flex flex-col lg:flex-row card card-side bg-base-100 shadow-xl border-2 h-64 w-1/2 mx-auto">
            ...
            <div className=" lg:hidden card card-compact  shadow-xl">
                {/* <figure><img src={providerInfo.providerImage} alt="imag" className="w-full h-[400px] md:px-10  md:h-[800px]" /></figure> */}
                <div className=" border p-4 rounded-2xl ">
                        <img src={providerInfo.providerImage} className="h-[300px] w-full md:h-[600px] md:w-full md:px-48 rounded-lg shadow-2xl" />
                    </div>
                ...
                <div className="hero-content gap-10 lg:gap-20 flex-col lg:flex-row item-center">
                    ...
                    <div className="border-2 p-3 px-10 rounded-2xl lg:h-[300px] md:w-full lg:w-1/2 flex-grow">
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            {/* <Link to={`/bookNowService/${_id}`}>
                            <button className="btn btn-warning w-full taxt-2xl font-bold">Book Now</button>
                            </Link> */}
